...
//             jwt.verify(user.refreshToken, process.env.JWT_SECRET, async (err, decodedRefresh) => {
//                 if (err) {
...
//                 console.log("TOKEN REGENERATED DUE TO REFRESH TOKEN (61): ", newToken);
...
//         }
//         else {
//             jwt.verify(JWT_TOKEN, process.env.JWT_SECRET, async (err, verifiedDecoded) => {
//                 if (err) {
//                     return res.status(401).json({ msg: 'Token is not valid' });
//                 }
//                 req.user = await User.findById(verifiedDecoded.id);
//                 if (!req.user) {
...
//             // Verify refresh token
//             jwt.verify(user.refreshToken, process.env.JWT_SECRET, async (err, decoded) => {
//                 if (err) {
...
//                 // Generate new access token
//                 const newToken = await generateToken(user);
//                 console.log("TOKEN REGENERATED DUE TO REFRESH TOKEN: ", newToken);
//                 res.setHeader('Authorization', 'Bearer ' + newToken);
//                 req.user = user;
//                 next();
//             });
