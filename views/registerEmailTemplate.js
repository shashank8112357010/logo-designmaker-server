            ...
            <td class="container" style="font-family: 'Inter', sans-serif; font-size: 16px; vertical-align: top; max-width: 600px; width: 600px; margin: 0 auto; padding: 20px; background-color: #0B1926; color: #FFFFFF;" width="600" valign="top">
                <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
                    ...
                    <div class="main-content" style="padding: 20px; border-radius: 8px;">
                        ...
                        <p style="font-size: 16px; color: #FFFFFF;">Welcome to Logo Design Maker! We are thrilled to have you join our community. Our mission is to provide one-stop service to users like you to bring their creative vision to life.</p>
                        <p style="font-size: 16px; color: #FFFFFF;">To get started, we recommend taking a few moments to explore our platform and familiarize yourself with our features. From our intuitive interface to our robust library of assets, we’ve designed our platform to be user-friendly as possible.</p>
                        <a class="button" href="http://localhost:3000/auth/sign-in" style="display: block; width: 200px; margin: 20px auto; padding: 10px 0; text-align: center; background-color: #5CFF85; color: #0B1926; border-radius: 20px; text-decoration: none; font-weight: 600;">Sign in to your account</a>
                        <p style="font-size: 16px; color: #FFFFFF;">We are committed to providing our users with the best possible experience on our platform. Our customer support team is available to assist you with any issues that you may encounter, and we encourage you to reach out to us if you need assistance.</p>
                        <p style="font-size: 16px; color: #FFFFFF;">Thank you for choosing Logo Design Maker. We look forward to seeing the amazing content that you will create.</p>
